    ...
    <div class="py-6 bg-green-50">
        ...
        <div class="p-6 mx-auto bg-white shadow-lg max-w-7xl sm:p-8 rounded-2xl">
                ...
                <form id="umscForm" novalidate>
                            ...
                            <div class="col-span-1">
                                ...
                                <div class="flex gap-2">
                                    <input type="number" id="healthConsultPeople" name="healthConsultPeople"
                                        ...
                                        placeholder="คน">
                                    <input type="number" id="healthConsultTimes" name="healthConsultTimes"
                                        min="0"
                    ...
                    <fieldset class="p-6 mb-8 bg-white border-t-4 border-green-700 rounded-lg shadow-sm">
                        <legend class="px-2 text-xl font-bold text-green-800">ข้อมูลการให้บริการผ่าน LINE Official
                            Account (LINE OA)</legend>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-4">
                            <div class="col-span-1">
                                ...
                                <div class="flex space-x-2">
                                    <input type="number" id="lineOATotalPeople" name="lineOATotalPeople"
                                        min="0" value="0"
                                        class="w-1/2 p-2 text-sm text-gray-700 bg-gray-100 border border-gray-300 rounded-md shadow-sm focus:ring-green-600 focus:border-green-600"
                                        readonly>
                                    <input type="number" id="lineOATotalTimes" name="lineOATotalTimes"
                                        min="0" value="0"
                                        class="w-1/2 p-2 text-sm text-gray-700 bg-gray-100 border border-gray-300 rounded-md shadow-sm focus:ring-green-600 focus:border-green-600"
                                        readonly>
                                </div>
                            ...
                            <div class="col-span-1">
                                ...
                                <div class="flex gap-2">
                                    <input type="number" id="lineOAhealthConsultPeople"
                                        name="lineOAhealthConsultPeople" min="0"
                                        ...
                                        placeholder="คน">
                                    <input type="number" id="lineOAhealthConsultTimes"
                                        name="lineOAhealthConsultTimes" min="0"
                            ...
                            <div class="col-span-1">
                                ...
                                <div class="flex gap-2">
                                    <input type="number" id="lineOAserviceAdvicePeople"
                                        name="lineOAserviceAdvicePeople" min="0"
                                        class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm line-sum-source-people focus:ring-green-600 focus:border-green-600"
                                        placeholder="คน">
                                    <input type="number" id="lineOAserviceAdviceTimes"
                                        name="lineOAserviceAdviceTimes" min="0"
                                        class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm line-sum-source-times focus:ring-green-600 focus:border-green-600"
                                        placeholder="ครั้ง">
                                </div>
                            </div>
                            ...
                            <div class="col-span-1">
                                ...
                                <div class="flex gap-2">
                                    <input type="number" id="lineOAreferralCoordPeople"
                                        name="lineOAreferralCoordPeople" min="0"
                                        class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm line-sum-source-people focus:ring-green-600 focus:border-green-600"
                                        placeholder="คน">
                                    <input type="number" id="lineOAreferralCoordTimes"
                                        name="lineOAreferralCoordTimes" min="0"
                                        class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm line-sum-source-times focus:ring-green-600 focus:border-green-600"
                                        placeholder="ครั้ง">
                                </div>
                            </div>
                            ...
                            <div class="col-span-1">
                                ...
                                <div class="flex gap-2">
                                    <input type="number" id="lineOAdisabilityCertPeople"
                                        ...
                                        class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm line-sum-source-people focus:ring-green-600 focus:border-green-600"
                                        placeholder="คน">
                                    <input type="number" id="lineOAdisabilityCertTimes"
                                        name="lineOAdisabilityCertTimes" min="0"
                                        class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm line-sum-source-times focus:ring-green-600 focus:border-green-600"
                                        placeholder="ครั้ง">
                                </div>
                            </div>
                            ...
                            <div class="col-span-1">
                                ...
                                <div class="flex gap-2">
                                    <input type="number" id="lineOAsupportRequestPeople"
                                        ...
                                        class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm line-sum-source-people focus:ring-green-600 focus:border-green-600"
                                        placeholder="คน">
                                    <input type="number" id="lineOAsupportRequestTimes"
                                        name="lineOAsupportRequestTimes" min="0"
                                        class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm line-sum-source-times focus:ring-green-600 focus:border-green-600"
                                        placeholder="ครั้ง">
                                </div>
                            </div>
                            ...
                            <div class="col-span-1">
                                ...
                                <div class="flex gap-2 mb-2">
                                    <input type="number" id="lineOAothersPeople" name="lineOAothersPeople"
                                        ...
                                        class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm line-sum-source-people focus:ring-green-600 focus:border-green-600"
                                        placeholder="คน">
                                    <input type="number" id="lineOAothersTimes" name="lineOAothersTimes"
                                        min="0"
                                        class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm line-sum-source-times focus:ring-green-600 focus:border-green-600"
                                        placeholder="ครั้ง">
                                </div>
