            ...
            <form id="umscForm" novalidate>
                ...
                <fieldset class="p-6 mb-8 bg-white border-t-4 border-green-700 rounded-lg shadow-sm">
                    ...
                    <p class="px-4 mb-5 text-xs text-gray-500">
                        (จำนวนการให้บริการ ดังนี้ จุดให้บริการ UMSC ในศูนย์บริการสาธารณสุข, Facebok, โทรศัพท์ เป็นต้น)
                    ...
                    <div class="grid grid-cols-1 gap-6 mt-4 md:grid-cols-2 lg:grid-cols-3 ">
                        <div class="col-span-1">
                            <label for="allUser" class="block mb-1 text-sm text-gray-700">
                                ผู้รับบริการทั้งหมด
                            </label>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="flex gap-2">
                                <input type="number" id="healthConsultPeople" name="healthConsultPeople" min="0"
                                    class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm sum-source-people focus:ring-green-600 focus:border-green-600"
                                    placeholder="คน">
                                <input type="number" id="disabilityCertPeople" name="disabilityCertPeople" min="0"
                                    class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm sum-source-times focus:ring-green-600 focus:border-green-600"
                                    placeholder="ครั้ง">
                            </div>
                        </div>
                        <div class="col-span-1">
                            ...
                            <div class="flex gap-2">
                                <input type="number" id="supportRequestPeople" name="supportRequestPeople" min="0"
                                    class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm sum-source-people focus:ring-green-600 focus:border-green-600"
                                    placeholder="คน">
                                <input type="number" id="supportRequestPeople" name="supportRequestPeople" min="0"
                                    class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm sum-source-times focus:ring-green-600 focus:border-green-600"
                ...
                <!-- Section 3 ข้อมูลการให้บริการผ่าน line-->
                <fieldset class="p-6 mb-8 bg-white border-t-4 border-green-700 rounded-lg shadow-sm">
                    <legend class="px-2 text-xl font-bold text-green-800">ข้อมูลการให้บริการผ่าน LINE Official Account (LINE OA)</legend>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-4">
                        <div class="col-span-1">
                            ...
                            <div class="flex space-x-2">
                                <input type="number" id="lineOATotalPeople" name="lineOATotalPeople" min="0" value="0"
                                    class="w-1/2 p-2 text-sm text-gray-700 bg-gray-100 border border-gray-300 rounded-md shadow-sm focus:ring-green-600 focus:border-green-600"
                                    readonly>
                                <input type="number" id="lineOATotalTimes" name="lineOATotalTimes" min="0" value="0"
                                    class="w-1/2 p-2 text-sm text-gray-700 bg-gray-100 border border-gray-300 rounded-md shadow-sm focus:ring-green-600 focus:border-green-600"
                                    readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="flex gap-2">
                                <input type="number" id="lineOAhealthConsultPeople" name="lineOAhealthConsultPeople" min="0"
                                    ...
                                    placeholder="คน">
                                <input type="number" id="lineOAhealthConsultTimes" name="lineOAhealthConsultTimes" min="0"
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="flex gap-2">
                                <input type="number" id="lineOAserviceAdvicePeople" name="lineOAserviceAdvicePeople" min="0"
                                    class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm line-sum-source-people focus:ring-green-600 focus:border-green-600"
                                    placeholder="คน">
                                <input type="number" id="lineOAserviceAdviceTimes" name="lineOAserviceAdviceTimes" min="0"
                                    class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm line-sum-source-times focus:ring-green-600 focus:border-green-600"
                                    placeholder="ครั้ง">
                            </div>
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="flex gap-2">
                                <input type="number" id="lineOAappointmentPeople" name="lineOAappointmentPeople" min="0"
                                    class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm line-sum-source-people focus:ring-green-600 focus:border-green-600"
                                    placeholder="คน">
                                <input type="number" id="lineOAappointmentTimes" name="lineOAappointmentTimes" min="0"
                                    class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm line-sum-source-times focus:ring-green-600 focus:border-green-600"
                                    placeholder="ครั้ง">
                            </div>
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="flex gap-2">
                                <input type="number" id="lineOAreferralCoordPeople" name="lineOAreferralCoordPeople" min="0"
                                    class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm line-sum-source-people focus:ring-green-600 focus:border-green-600"
                                    placeholder="คน">
                                <input type="number" id="lineOAreferralCoordTimes" name="lineOAreferralCoordTimes" min="0"
                                    class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm line-sum-source-times focus:ring-green-600 focus:border-green-600"
                                    placeholder="ครั้ง">
                            </div>
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="flex gap-2">
                                <input type="number" id="lineOAhomeVisitPeople" name="lineOAhomeVisitPeople" min="0"
                                    class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm line-sum-source-people focus:ring-green-600 focus:border-green-600"
                                    placeholder="คน">
                                <input type="number" id="lineOAhomeVisitTimes" name="lineOAhomeVisitTimes" min="0"
                                    class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm line-sum-source-times focus:ring-green-600 focus:border-green-600"
                                    placeholder="ครั้ง">
                            </div>
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="flex gap-2">
                                <input type="number" id="lineOAdisabilityCertPeople" name="lineOAdisabilityCertPeople" min="0"
                                    class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm line-sum-source-people focus:ring-green-600 focus:border-green-600"
                                    placeholder="คน">
                                <input type="number" id="lineOAdisabilityCertTimes" name="lineOAdisabilityCertTimes" min="0"
                                    class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm line-sum-source-times focus:ring-green-600 focus:border-green-600"
                                    placeholder="ครั้ง">
                            </div>
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="flex gap-2">
                                <input type="number" id="lineOAsupportRequestPeople" name="lineOAsupportRequestPeople" min="0"
                                    class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm line-sum-source-people focus:ring-green-600 focus:border-green-600"
                                    placeholder="คน">
                                <input type="number" id="lineOAsupportRequestTimes" name="lineOAsupportRequestTimes" min="0"
                                    class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm line-sum-source-times focus:ring-green-600 focus:border-green-600"
                                    placeholder="ครั้ง">
                            </div>
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="flex gap-2">
                                <input type="number" id="lineOAtelehealthPeople" name="lineOAtelehealthPeople" min="0"
                                    class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm line-sum-source-people focus:ring-green-600 focus:border-green-600"
                                    placeholder="คน">
                                <input type="number" id="lineOAtelehealthTimes" name="lineOAtelehealthTimes" min="0"
                                    class="w-1/2 p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm line-sum-source-times focus:ring-green-600 focus:border-green-600"
                                    placeholder="ครั้ง">
                            </div>
                        </div>
                        ...
                        <!--lineOAResponse-->
                        <div class="col-span-1">
                            <label for="lineOAResponse" class="block mb-1 text-xs font-bold text-red-500">
                                จำนวนการตอบกลับภายใน 30 นาที
                            </label>
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                        ...
                        <div>
                            ...
                            <input type="tel" id="reporterPhone" name="reporterPhone" maxlength="12"
                                oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\d{2})(\d{4})(\d{0,4}).*/, '$1-$2-$3')"
                                class="w-full p-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm focus:ring-green-600 focus:border-green-600"
