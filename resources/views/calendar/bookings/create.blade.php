        ...
        <div class="p-6 mx-auto bg-white shadow-lg max-w-7xl sm:p-8 rounded-2xl">
            ...
            <form action="{{ route('booking.store') }}" method="POST" class="space-y-6">
                ...
                <fieldset class="p-6 mb-8 bg-white border-t-4 border-green-700 rounded-lg shadow-sm">
                    ...
                    <div>
                        <label
                            class="block mb-1 text-sm text-gray-700">ชื่อเรื่องหัวข้อการประชุม/การจัดกิจกรรม/การจัดงาน
                ...
                <fieldset class="p-6 mb-8 bg-white border-t-4 border-green-700 rounded-lg shadow-sm">
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
                        <div>
                            <label class="block mb-1 text-sm text-gray-700">วันที่เริ่มต้น <span
                                    class="text-red-500">*</span></label>
                            <input type="text" id="start_date" name="start_date" required
                                placeholder="คลิกเพื่อเพิ่มวันที่เริ่มต้น"
                                class="w-full text-sm text-gray-700 placeholder-gray-400 border-gray-300 rounded-md shadow-sm focus:ring-green-600 focus:border-green-600">
                        </div>
                        <div>
                            <label class="block mb-1 text-sm text-gray-700">วันที่สิ้นสุด <span
                                    class="text-red-500">*</span></label>
                            <input type="text" id="end_date" name="end_date" required readonly
                                placeholder="คลิกเพื่อเพิ่มวันที่สิ้นสุด"
                                class="w-full text-sm text-gray-700 placeholder-gray-400 border-gray-300 rounded-md shadow-sm focus:ring-green-600 focus:border-green-600">
                        </div>
                        <div>
                            <label class="block mb-1 text-sm text-gray-700">เวลาเริ่มต้น <span
                                    class="text-red-500">*</span></label>
                            <input type="text" id="start_time" name="start_time" required readonly
                                placeholder="คลิกเพื่อเลือกเวลาเริ่มต้น"
                                class="w-full text-sm text-gray-700 placeholder-gray-400 border-gray-300 rounded-md shadow-sm focus:ring-green-600 focus:border-green-600">
                        </div>
                        <div>
                            <label class="block mb-1 text-sm text-gray-700">เวลาสิ้นสุด <span
                                    class="text-red-500">*</span></label>
                            <input type="text" id="end_time" name="end_time" required readonly
                                placeholder="คลิกเพื่อเลือกเวลาสิ้นสุด"
                                class="w-full text-sm text-gray-700 placeholder-gray-400 border-gray-300 rounded-md shadow-sm focus:ring-green-600 focus:border-green-600">
                        </div>
                    </div>
                </fieldset>
                ...
                <fieldset class="p-6 mb-8 bg-white border-t-4 border-green-700 rounded-lg shadow-sm">
                    ...
                    <div class="grid grid-cols-1 gap-2 mt-6 md:grid-cols-2">
                        ...
                        <!-- 2.6 ส่วนราชการ -->
                        <div>
                            <label class="block mb-1 text-sm text-gray-700">ส่วนราชการ <span
                                    class="text-red-500">*</span></label>
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                        <div>
                            ...
                            <input type="text" id="coordinatorName" name="coordinatorName"
                                class="w-full p-2 text-sm text-gray-700 placeholder-gray-400 border border-gray-300 rounded-md shadow-sm focus:ring-green-600 focus:border-green-600"
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // 1. ตั้งค่าพื้นฐานแบบไม่มีฟังก์ชัน formatDate มาขัดขวาง
            const dateConfig = {
                locale: 'th',
                altInput: true,      // แสดงผลภาษาไทยให้คนดู
                altFormat: "j F Y",  // เช่น 26 มีนาคม 2569
                dateFormat: "Y-m-d", // ส่งค่าไป DB เป็นสากล เช่น 2026-03-26 [cite: 119]
                allowInput: true,
                minDate: "today",    // [cite: 120]

                // ปุ่ม today และ clear (คงไว้เหมือนเดิม)
                onReady: function(selectedDates, dateStr, instance) {
                    ...
                    todayBtn.onclick = () => { instance.setDate(new Date()); instance.close(); };
