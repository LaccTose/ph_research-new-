    ...
    <div class="py-6 bg-green-50">
        <div class="p-6 mx-auto bg-white shadow-lg max-w-7xl sm:p-8 rounded-2xl">
            ...
            <div class="mb-8 text-center">
                <h1 class="text-2xl font-bold text-green-800 sm:text-3xl md:text-4xl">
            ...
            <form id="umscForm" novalidate>
                ...
                <fieldset class="p-6 mb-8 bg-white border-t-4 border-green-700 rounded-lg shadow-sm">
                    ...
                    <div class="grid grid-cols-1 gap-6 mt-4 md:grid-cols-3">
                        <div>
                            <label for="healthCenter" class="block mb-1 text-sm font-medium text-gray-700">
                                ศูนย์บริการสาธารณสุข <span class="text-red-500">*</span>
                            </label>
                            <select id="healthCenter" name="healthCenter" required
                                class="w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-green-600 focus:border-green-600">
                                @for ($i = 1; $i <= 69; $i++)
                        ...
                        <div>
                            <label for="month" class="block mb-1 text-sm font-medium text-gray-700">
                ...
                <fieldset class="p-6 mb-8 bg-white border-t-4 border-green-700 rounded-lg shadow-sm">
                    <legend class="px-4 text-xl text-green-800">ตัวอย่างข้อมูลการให้บริการ</legend>
                    ...
                    <div class="grid grid-cols-1 gap-6 mt-4 md:grid-cols-2 lg:grid-cols-3">
                        <div class="col-span-1">
                            ...
                            <div class="flex gap-2">
                                <input type="number" id="allUser" name="allUser" min="0" value="0"
                                    class="w-1/2 p-2 bg-gray-100 border border-gray-300 rounded-md shadow-sm" readonly>
                        ...
                        <div class="col-span-1">
                            <label for="othersPeople" class="block mb-1 text-sm font-medium text-gray-700">
                                9. อื่นๆ</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-4">
                        ...
                        <div class="col-span-1">
                            <label for="lineOATotalPeople"
                                class="block mb-1 text-sm font-medium text-gray-700">ผู้รับบริการทั้งหมด (LINE
                                OA)</label>
                        ...
                        <div class="col-span-1">
                            <label for="lineOAhealthConsultPeople"
                                class="block mb-1 text-sm font-medium text-gray-700">1.
                        ...
                        <div class="col-span-1">
                            <label for="lineOAserviceAdvicePeople"
                                class="block mb-1 text-sm font-medium text-gray-700">2.
                        ...
                        <div class="col-span-1">
                            <label for="lineOAappointmentPeople"
                                class="block mb-1 text-sm font-medium text-gray-700">3.
                        ...
                        <div class="col-span-1">
                            <label for="lineOAreferralCoordPeople"
                                class="block mb-1 text-sm font-medium text-gray-700">4.
                        ...
                        <!--5.lineOAhomeVisit-->
                        <div class="col-span-1">
                            <label for="lineOAhomeVisitPeople" class="block mb-1 text-sm font-medium text-gray-700">5.
                        ...
                        <div class="col-span-1">
                            <label for="lineOAdisabilityCertPeople"
                                class="block mb-1 text-sm font-medium text-gray-700">6.
                        ...
                        <div class="col-span-1">
                            <label for="lineOAsupportRequestPeople"
                                class="block mb-1 text-sm font-medium text-gray-700">7.
                        ...
                        <div class="col-span-1">
                            <label for="lineOAtelehealthPeople"
                                class="block mb-1 text-sm font-medium text-gray-700">8.
                                Telehealth</label>
                            <div class="flex gap-2">
                        ...
                        <!--9.lineOAOther-->
                        <div class="col-span-1">
                            <label for="lineOAothersPeople" class="block mb-1 text-sm font-medium text-gray-700">9.
                                อื่น
                                ๆ</label>
                            <div class="flex gap-2 mb-2">
                ...
                <fieldset class="p-6 mb-8 bg-white border-t-4 border-green-700 rounded-lg shadow-sm">
                    ...
                    <div class="grid grid-cols-1 gap-6 mt-4 md:grid-cols-3">
                        <div>
                            <label for="reporterName" class="block mb-1 text-sm font-medium text-gray-700">
                        ...
                        <div>
                            <label for="reporterPosition" class="block mb-1 text-sm font-medium text-gray-700">
                                ตำแหน่ง <span class="text-red-500">*</span>
                            </label>
                            <input type="text" id="reporterPosition" name="reporterPosition"
                                class="w-full p-2 border border-gray-300 rounded-md shadow-sm" placeholder="ตำแหน่ง">
                        </div>
                        ...
                        <div>
                            ...
                            oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\d{2})(\d{4})(\d{0,4}).*/, '$1-$2-$3')" class="w-full p-2 border border-gray-300 rounded-md shadow-sm" placeholder="00-0000-0000">
                        </div>
                ...
                <div class="flex justify-end mt-6 space-x-4">
                    <button type="submit"
                        class="px-6 py-3 text-white transition bg-green-700 rounded-lg hover:bg-green-800">
                        บันทึกข้อมูล
                    </button>
                    <button type="reset"
                        class="px-6 py-3 text-gray-700 transition bg-gray-300 rounded-lg hover:bg-gray-400">
                        ล้างข้อมูล
                    </button>
                </div>
            </form>
